...
})({"2YbIV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "583af2a2c4255420";
"use strict";
...
},{}],"1SdWS":[function(require,module,exports) {
...
const convertMilliseconds = (milliseconds)=>{
    ...
    if (milliseconds && milliseconds > 0) {
        ...
        if (days > 0) {
            ...
            else dayStr = `${days} day, `;
        } else dayStr = "";
        if (hours > 0) {
            if (hours > 1) hourStr = `${hours} hours, `;
            else hourStr = `${hours} hour, `;
        } else hourStr = "";
        if (minutes > 0) {
            if (minutes > 1) minuteStr = `${minutes} minutes, `;
            else minuteStr = `${minutes} minute, `;
        } else minuteStr = "";
        if (seconds > 0) {
            if (seconds > 1) secondStr = `${seconds} seconds, `;
            else secondStr = `${seconds} second, `;
        } else secondStr = "";
        if (milliseconds > 1) milliStr = `${milliseconds} milliseconds`;
        else milliStr = `${milliseconds} millisecond`;
...
let ageUser = JSON.stringify((0, _lodashDefault.default).groupBy(users, "age"));
console.log(ageUser);
...
},{}]},["2YbIV","1SdWS"], "1SdWS", "parcelRequire2df7")

//# sourceMappingURL=index.c4255420.js.map
